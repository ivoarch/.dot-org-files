...
I use Menlo as my font choice.

#+begin_src sh :tangle ~/.Xdefaults :padline yes
URxvt*letterSpace: -1
URxvt*font:                 xft:Menlo:style=regular:size=10
URxvt*imFont:               xft:Menlo:style=regular:size=10
URxvt*boldFont:             xft:Menlo:style=bold:size=10
URxvt*italicFont:           xft:Menlo:style=italic:size=10
URxvt*boldItalicFont:       xft:Menlo:style=bold:italic:size=10
#+end_src
