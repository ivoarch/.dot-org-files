...
I set up a mailto handler in Conkeror with Emacs. For more info see this [[http://www.emacswiki.org/emacs/MailtoHandler][link]].
...
1. Installing xpi files from unknown sites.
2. Disable extension compatability checking.
